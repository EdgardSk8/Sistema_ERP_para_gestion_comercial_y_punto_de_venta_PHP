<div class="d-flex justify-content-between align-items-center">
    ...
    <div class="d-flex align-items-center gap-3">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-3 dropdown-columns">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="colNombre">Nombre del Tipo de Gasto</label>
                </div>
        ...
        <!-- Botón agregar -->
        <button type="button" class="btn-agregar" data-bs-toggle="modal" data-bs-target="#modalCrearTipoGasto">
            + Agregar Tipo de Gasto
        </button>

        <!-- Toggle inactivos -->
        <input type="checkbox" id="toggleInactivosTipoGasto" class="togglecheck" hidden checked>
        <label for="toggleInactivosTipoGasto" class="toggle-btn">
            Ocultar inactivos
        </label>
